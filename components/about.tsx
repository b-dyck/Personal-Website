...
export default function About() {
  return (
    <section className='mb-28 max-w-[45rem] flex flex-col align-middle justify-center text-center leading-6 sm:mb-40'>
        <motion.h2 className='font-bold pt-4 pb-4 text-center text-2xl sm:text-3xl'
